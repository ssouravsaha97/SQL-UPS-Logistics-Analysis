...
## Delivery Agent Performance
![Delivery Agent Performance](screenshots/delivery_agent_performance.png)

---

## Rank Agents by On-Time Delivery
![Agent Ranking](screenshots/agent_ranking_per_route.png)

---

## Top 5 vs Bottom 5 Agent Speed
![Agent Speed](screenshots/top_vs_bottom_agents_speed.png)

---

## Shipment Tracking Analysis
![Shipment Tracking](screenshots/shipment_tracking_dashboard.png)

---

## Last Checkpoint Per Order
![Last Checkpoint](screenshots/last_checkpoint_per_order.png)

---

## Orders with Multiple Delays
![Multiple Delays](screenshots/orders_multiple_delay_checkpoints.png)

---

## Most Common Delay Reasons
![Delay Reasons](screenshots/most_common_delay_reasons.png)

---

## Warehouse Ranking by Performance
![Warehouse Ranking](screenshots/warehouse_on_time_ranking.png)

---

## Average Traffic Delay per Route
![Traffic Delay](screenshots/average_traffic_delay_route.png)

---

## Average Delivery Delay by Region
![Region Delay](screenshots/average_delivery_delay_region.png)
